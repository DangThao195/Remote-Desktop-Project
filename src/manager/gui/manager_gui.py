...
from PyQt6.QtWidgets import (
    ...
    QListWidget, QPushButton, QLabel, QListWidgetItem, QDialog, QLineEdit,
...
class LoginDialog(QDialog):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Manager Sign In")
    ...
    def init_ui(self):
        ...
        title = create_title("Manager Sign In", 28)
    ...
    def sign_in(self):
        ...
        # For manager, just accept login (no auth check)
        QMessageBox.information(None, "Success", f"Logged in as {username}!")
        self.accept()
